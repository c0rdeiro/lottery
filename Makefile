...
deploy-sepolia:
	@forge script script/DeployRaffle.s.sol:DeployRaffle  --rpc-url $(SEPOLIA_RPC_URL) --account sepolia --broadcast --verify --etherscan-api-key $(SEPOLIA_ETHERSCAN_API_KEY) -vvvv
